...
def image(pred):
    if pred < 0.3:
        return st.image('0.png', width=100, caption='Negative')
    elif pred <= 0.6:
        return st.image('1.png', width=100, caption='Negative')
    elif pred > 0.9:
        return st.image('3.png', width=100, caption='Positive')
    else: 
        return st.image('2.png', width=100, caption='Positive')
